...
namespace Despair
{
    ...
    public static class ConsoleLayout
    {
        ...
        public static int WindowHeight = 42;
        ...
        public static int FooterPositionTop = 39;

        //
        // menu box configuration
        //
        public static int MenuBoxWidth = 37;
        public static int MenuBoxHeight = 14;
        public static int MenuBoxPositionLeft = 112;
        public static int MenuBoxPositionTop = 3;

        //
        // message box configuration
        //
        public static int MessageBoxWidth = 110;
        public static int MessageBoxHeight = 32;
        ...
        //
        public static int InputBoxWidth = 110;
        public static int InputBoxHeight = 4;
        public static int InputBoxPositionLeft = 1;
        public static int InputBoxPositionTop = 35;

        //
        // status box configuration
        //
        public static int StatusBoxWidth = 37;
        public static int StatusBoxHeight = 22;
        public static int StatusBoxPositionLeft = 112;
        public static int StatusBoxPositionTop = 17;
    }
}
